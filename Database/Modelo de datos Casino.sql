...
-- TABLA SavageHands (BLACKJACK)
CREATE TABLE SAVAGEHANDS (
	ID_LOG_SAVAGEHANDS INT NOT NULL AUTO_INCREMENT,
    FECHA_LOG_SAVAGEHANDS TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    APUESTA INT NOT NULL,
    RESULTADO DOUBLE (10,2) NOT NULL,
    ID_HISTORICO INT NOT NULL,
    DNI VARCHAR(9) NOT NULL,
    ID_JUEGO INT NOT NULL,
    CONSTRAINT PK_SAVAGEHANDS PRIMARY KEY (ID_LOG_SAVAGEHANDS),
    CONSTRAINT FK_HISTORICO_SAVAGEHANDS FOREIGN KEY (ID_HISTORICO) REFERENCES HISTORICO (ID_HISTORICO),
    CONSTRAINT FK_USUARIOHISTORICO_SAVAGEHANDS FOREIGN KEY (DNI) REFERENCES USUARIO (DNI),
    CONSTRAINT FK_JUEGOHISTORICO_SAVAGEHANDS FOREIGN KEY (ID_JUEGO) REFERENCES JUEGO (ID_JUEGO)
);

-- Insertar un usuario en la tabla USUARIO
INSERT INTO USUARIO (DNI, NOMBRE, APELLIDO1, APELLIDO2, FECHA_NACIMIENTO, USER_NAME, EMAIL, USER_PASSWORD, NUMERO_TELEFONO, DINERO_USUARIO, ES_VIP, TITULAR_TARJETA, NUMERO_TARJETA, FECHA_EXPIRACION, CVC)
